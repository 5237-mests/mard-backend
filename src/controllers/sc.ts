...
//     const { shopId, customerName, customerContact, items } = req.body as SaleRequestBody;
...
// SalesController.ts (Complete with improvements: validation, auth checks, pagination)
