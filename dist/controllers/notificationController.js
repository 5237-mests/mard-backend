...
const unreadCount = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const count = yield (0, notificationService_1.getUnreadNotificationCount)(userId);
...
const listNotifications = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user.id;
    try {
        const notifications = yield (0, notificationService_1.getUserNotifications)(userId);
...
const markAsRead = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { notificationId } = req.body;
    try {
        yield (0, notificationService_1.markNotificationAsRead)(notificationId);
