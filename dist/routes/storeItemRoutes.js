...
router.post("/:storeId/items/:itemId", storeItemController_1.storeItemController.addstoreItem);
// Route to update the quantity of a specific item in a specific store
router.put("/:storeId/items/:itemId", storeItemController_1.storeItemController.updatestoreItemQuantity);
// Route to delete a specific item from a specific store
router.delete("/:storeId/items/:itemId", storeItemController_1.storeItemController.deletestoreItem);
// Route to add multiple items to a store
router.post("/:storeId/items", storeItemController_1.storeItemController.addMultiplestoreItems);
