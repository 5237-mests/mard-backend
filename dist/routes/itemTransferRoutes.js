...
router.post("/create_transfer", authMiddleware_1.authenticateToken, authMiddleware_1.authorizeUser, (0, authMiddleware_1.authorizeRole)(["ADMIN", "STOREKEEPER"]), itemTransferController_1.itemTransferController.createTransfer);
...
router.get("/:id", authMiddleware_1.authenticateToken, itemTransferController_1.itemTransferController.getTransferById);
