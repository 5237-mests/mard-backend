...
router.post("/create", authMiddleware_1.authenticateToken, (0, authMiddleware_1.authorizeRole)(["ADMIN"]), upload.single("image"), //image upload
...
// );
router.put("/update/:id", authMiddleware_1.authenticateToken, (0, authMiddleware_1.authorizeRole)(["ADMIN"]), upload.single("image"), // image update
itemController_1.default.updateItem.bind(itemController_1.default));
